...
description: Binding nyxx with nyxx_commands for command handling
...
[Writing your first bot](/tutorials/writing_your_first_bot) before continuing.
...
![Bot in command menu](/images/tutorial/bot_in_command_menu.png)

Typing in `/ping` will show us the command we just created...

![Bot in command menu](/images/tutorial/ping_command_in_command_menu.png)

...and we can press enter to execute it, after which our bot will respond with its latency.

![Result of running ping command](/images/tutorial/simple_ping_command_executed.png)

We can also run our command using the prefixes we defined by sending a message to the channel.


![Result of running ping command](/images/tutorial/simple_ping_command_executed_text_mode.png)
...
![Bot prompting for selection](/images/tutorial/ping_command_empty_selection.png)

Selecting different metrics gives us different latency values.

![Command execution with different selections](/images/tutorial/ping_command_multiple_selections_string.png)
...
![Bot in command menu](/images/tutorial/ping_command_in_command_menu_with_arguments.png)
...
![Bot in command menu](/images/tutorial/ping_command_executed_with_argument.png)
...
![Bot in command menu](/images/tutorial/ping_command_in_command_menu_with_choices.png)
...
![Bot in command menu](/images/tutorial/ping_command_invalid_input_response.png)
