...
import SelectMenu from '@site/src/components/Discord/DiscordMultiSelect'
import Test from '@site/src/components/Discord/test'
...
```
<Component commandContent={'help'} content={'Hey, I got buttons!'} buttonsContent={['This is button label', 'This is another button']} buttonTypes={['success', 'success']} />
