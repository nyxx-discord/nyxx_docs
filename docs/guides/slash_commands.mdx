...
import { PingCommandSlash } from '@site/src/components/Discord/pingCommand';
...
<PingCommandSlash content={'Pong!'} commandContent={'ping'} />
...
<PingCommandSlash content={'You flipped: heads'} commandContent={'game'}/>
...
<PingCommandSlash content={'Respond'} commandContent={'testcommand'} ephemeral={true}/>
