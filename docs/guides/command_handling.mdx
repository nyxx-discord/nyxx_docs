...
<BaseCommand reply author="abitofevrything" commandContent="!say hi">hi</BaseCommand>
<br />
Will not work properly:
<BaseCommand reply author="abitofevrything" commandContent="!say hello, nyxx_commands!">hello,</BaseCommand>
But,
<BaseCommand reply author="abitofevrything" commandContent={'!say "hello, nyxx commands"'}>hello, nyxx_commands!</BaseCommand>
Will work.
:::
...
```
<BaseCommand author="abitofevrything" reply commandContent="!fruit">Your favourite fruit is apple!</BaseCommand>
<BaseCommand author="abitofevrything" reply commandContent="!fruit banana">Your favourite fruit is banana!</BaseCommand>
<br />
