...
The first parameter to this function must be a [`IContext`].

A [`IContext`] allows you to access various information about how the command was run: the user that executed it, the guild it was ran in and a few other useful pieces of information.
[`IContext`] also has a couple of methods that make it easier to respond to commands.
...
Message commands:
<BaseCommand reply={true} author="abitofevrything" commandContent="!throw coin">
  The coin landed on its head!
</BaseCommand>
<BaseCommand reply={true} author="abitofevrything" commandContent="!throw die">
...
<br />
<br />
<BaseCommand author="abitofevrything" commandContent="throw" isCommand={true}>
...
```dart
//highlight-next-line
context.respond('The die landed on the $number number!', mention: false);
```
And it should be like this:
<BaseCommand reply={true} mention={false} commandContent="!throw die" author="abitofevrything">
The die landed on the 3 number!
</BaseCommand>

[`nyxx_commands`]: https://github.com/nyxx-discord/nyxx_commands/tree/main
[`chatcommand`]: https://github.com/nyxx-discord/nyxx_commands/blob/main/lib/src/commands/chat_command.dart#L259
[`chatgroup`]: https://github.com/nyxx-discord/nyxx_commands/blob/main/lib/src/commands/chat_command.dart#L191
[`icontext`]: https://github.com/nyxx-discord/nyxx_commands/blob/main/lib/src/context/context.dart#L25
[`execute`]: https://github.com/nyxx-discord/nyxx_commands/blob/main/lib/src/commands/chat_command.dart#L303
[`children`]: https://github.com/nyxx-discord/nyxx_commands/blob/main/lib/src/commands/chat_command.dart#L215
[`addcommand`]: https://github.com/nyxx-discord/nyxx_commands/blob/main/lib/src/commands/chat_command.dart#L75
[`MessageChatContext`]: https://github.com/nyxx-discord/nyxx_commands/blob/main/lib/src/context/chat_context.dart#L54
[`respond`]: https://github.com/nyxx-discord/nyxx_commands/blob/main/lib/src/context/chat_context.dart#L54
[`mention`]: https://github.com/nyxx-discord/nyxx_commands/blob/main/lib/src/context/chat_context.dart#L55
