...
<BaseCommand reply={true} author="abitofevrything" commandContent="!say hi">hi</BaseCommand>
<br />
Will not work properly:
<BaseCommand reply={true} author="abitofevrything" commandContent="!say hello, nyxx_commands!">hello,</BaseCommand>
But,
<BaseCommand reply={true} author="abitofevrything" commandContent={'!say "hello, nyxx commands"'}>hello, nyxx_commands!</BaseCommand>
Will work
:::
...
```
<BaseCommand author="abitofevrything" reply={true} commandContent="!fruit">Your favourite fruit is apple!</BaseCommand>
<BaseCommand author="abitofevrything" reply={true} commandContent="!fruit banana">Your favourite fruit is banana!</BaseCommand>
<br />
...
That's all!
You just need to create a function or a class in a specific file, importing it, and register the function.
...
[`icontext`]: https://pub.dev/documentation/nyxx_commands/latest/nyxx_commands/IContext-class.html
